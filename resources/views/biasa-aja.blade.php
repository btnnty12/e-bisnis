...
<head>
    ...
    <title>MoodFood – Rekomendasi Biasa Aja</title>
...
<body data-page="2" class="bg-gradient-to-br from-white via-gray-50 to-slate-50 min-h-screen font-sans">

    <!-- Top Navigation -->
    <div class="max-w-2xl mx-auto mt-4 sm:mt-6 px-4">
        <div class="flex items-center gap-3 sm:gap-4 bg-gradient-to-r from-gray-300 via-gray-400 to-slate-300 p-4 sm:p-5 rounded-2xl shadow-lg animate-slideUp">
            <a href="{{ route('home') }}" class="text-black text-xl sm:text-2xl hover:scale-110 transition-transform">&#8592;</a>
            <div class="flex-1">
                <p class="font-semibold text-base sm:text-lg md:text-xl">Mood: Biasa Aja 😐</p>
                <p class="text-xs sm:text-sm text-black/70 -mt-1">Pilihan makanan klasik yang selalu enak</p>
            </div>
        </div>
    </div>
    ...
    <div class="max-w-2xl mx-auto mt-4 sm:mt-6 px-4 space-y-3 sm:space-y-4 pb-20">
        ...
        <div class="menu-card flex items-center bg-white rounded-2xl p-3 sm:p-4 shadow-md animate-fadeIn" style="animation-delay: 0.1s;">
            ...
            <div class="flex-1 ml-3 sm:ml-4 min-w-0">
                <p class="font-semibold text-sm sm:text-base">Nasi Goreng Spesial</p>
                <p class="text-xs sm:text-sm text-gray-500 -mt-1">Warung Nusantara</p>
                <div class="flex items-center text-xs text-gray-600 mt-1">
                    ⭐ 4.7 &nbsp; ⏱ 12 min
                </div>
            </div>
            <div class="flex flex-col items-end gap-2 ml-2">
                <p class="font-semibold text-xs sm:text-sm text-gray-800">Rp 28.000</p>
        ...
        <div class="menu-card flex items-center bg-white rounded-2xl p-3 sm:p-4 shadow-md animate-fadeIn" style="animation-delay: 0.2s;">
            <img src="https://via.placeholder.com/70" class="w-16 h-16 sm:w-20 sm:h-20 rounded-xl object-cover flex-shrink-0" />
            <div class="flex-1 ml-3 sm:ml-4 min-w-0">
                <p class="font-semibold text-sm sm:text-base">Mie Ayam Bakso</p>
                <p class="text-xs sm:text-sm text-gray-500 -mt-1">Bakso Malang</p>
                <div class="flex items-center text-xs text-gray-600 mt-1">
                    ⭐ 4.6 &nbsp; ⏱ 10 min
                </div>
            </div>
            <div class="flex flex-col items-end gap-2 ml-2">
                <p class="font-semibold text-xs sm:text-sm text-gray-800">Rp 30.000</p>
                <button class="btn-pesan bg-black text-white px-3 sm:px-4 py-1.5 sm:py-2 rounded-xl text-xs sm:text-sm font-medium">Pesan</button>
            </div>
        </div>
        ...
        <div class="menu-card flex items-center bg-white rounded-2xl p-3 sm:p-4 shadow-md animate-fadeIn" style="animation-delay: 0.3s;">
            <img src="https://via.placeholder.com/70" class="w-16 h-16 sm:w-20 sm:h-20 rounded-xl object-cover flex-shrink-0" />
            <div class="flex-1 ml-3 sm:ml-4 min-w-0">
                <p class="font-semibold text-sm sm:text-base">Gado-Gado</p>
                <p class="text-xs sm:text-sm text-gray-500 -mt-1">Warung Nusantara</p>
                <div class="flex items-center text-xs text-gray-600 mt-1">
                    ⭐ 4.8 &nbsp; ⏱ 15 min
                </div>
            ...
            <div class="flex flex-col items-end gap-2 ml-2">
                <p class="font-semibold text-xs sm:text-sm text-gray-800">Rp 25.000</p>
                <button class="btn-pesan bg-black text-white px-3 sm:px-4 py-1.5 sm:py-2 rounded-xl text-xs sm:text-sm font-medium">Pesan</button>
            </div>
        </div>
        ...
        <div class="menu-card flex items-center bg-white rounded-2xl p-3 sm:p-4 shadow-md animate-fadeIn" style="animation-delay: 0.4s;">
            <img src="https://via.placeholder.com/70" class="w-16 h-16 sm:w-20 sm:h-20 rounded-xl object-cover flex-shrink-0" />
            <div class="flex-1 ml-3 sm:ml-4 min-w-0">
                <p class="font-semibold text-sm sm:text-base">Sate Ayam</p>
                <p class="text-xs sm:text-sm text-gray-500 -mt-1">Sate Khas Madura</p>
                <div class="flex items-center text-xs text-gray-600 mt-1">
                    ⭐ 4.9 &nbsp; ⏱ 18 min
                </div>
            </div>
            <div class="flex flex-col items-end gap-2 ml-2">
                <p class="font-semibold text-xs sm:text-sm text-gray-800">Rp 38.000</p>
                <button class="btn-pesan bg-black text-white px-3 sm:px-4 py-1.5 sm:py-2 rounded-xl text-xs sm:text-sm font-medium">Pesan</button>
            </div>
        </div>
    </div>
